...
console.log(text.charAt(4)); // Retorna a letra que está no índice 4, no e é o 'r'
...
console.log('Aline, Helen, Luan'.split(',')); // Quebra a string a partir do separador definido, guardando em um array